	...
	public function admin_enqueue_scripts() {
		...
		acf_localize_text(
			array(
				...
				// Pro-only fields.
				'Repeater (ACF Pro only)'           => __( 'Repeater (ACF Pro only)', 'acf' ),
				'Flexibly Content (ACF Pro only)'   => __( 'Flexible Content (ACF Pro only)', 'acf' ),
				'Clone (ACF Pro only)'              => __( 'Clone (ACF Pro only)', 'acf' ),
				'Gallery (ACF Pro only)'            => __( 'Gallery (ACF Pro only)', 'acf' ),
			)
		);
