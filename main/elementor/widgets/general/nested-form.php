...
class Nested_Form extends Widget_Nested_Base {
	...
	public function hide_on_search(){
		if( 'nested-frontend-form' == $this->get_name() ) return true;
		return false;
	}
	...
	protected function register_controls() {
		...
		$this->add_control( 'form_steps_upsale', [
			...
			'raw' => '
				<h3>Multi Step Forms coming soon to Frontend Admin PRO!</h3>
				<br>
				<p>Upgrade to Frontend Admin PRO to unlock this feature and many more.</p>
				<br>
				<p><a href="'.$link_to_pro.'" target="_blank" class="elementor-button elementor-button-primary">Upgrade to PRO</a></p>
			',
		] );
	...
	protected function render() {		
		...
		$form = apply_filters( 'frontend_admin/show_form', $settings );
	...
	public function prepare_form( $form = array() ){
		...
		if( $fea_form && $fea_form['id'] == $form_id ) return $fea_form;	
